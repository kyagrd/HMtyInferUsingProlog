...
In case of repeated variable names, choosing the first reflects shadowing (most recently bound variable). %% fix?
...
We could also allow polymorphic recursion by type annotations on the
let-bound variable, like we will do for Mendler-style iteration \ref{ssec:mit}.
