...
the \verb|type| predicate.\footnote{
  ...
  these kind of extra arguments for threading accumulated differences.
  Here, we choose to stick to more basic constructs to be more accessible,
  relying less on background knowledge of Prolog idioms and libraries.}
...
over non-regular datatypes \ref{ssec:mit}.
