...
the expression {\small\verb|E|} can be assinged a type {\verb|T|} under the
typing context {\small\verb|C|}. A typing
context is a list of binidings. There are two kinds of bindings in HM: 
...
The two rules for lambda expresions and applications are self-explanatory.
...
The typing context {\small\texttt{C}} inside the polymoprhic bniding
...
a fresh varaible {\small\verb|Y1|} but {\small\verb|X|} stays the same
...
iteration -- one for regular datatypes and the other for non-reglar datatypes.
