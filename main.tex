...
\begin{verbatim}
  ...
  first(K:V,[K1:V1|Xs]) :- K=K1 -> V=V1 ; first(K:V, Xs).
\end{verbatim}
\caption{HM in Prolog \cite{lpaste}}
\label{fig:HM}
\end{figure}
...
known as System \Fw\ [TODO cite Fw]. Type constructors in \Fw\ can have
...
System~\Fi\ \cite{AhnSheFioPit13} extends extend the kind structure
